...
public fun cryptoActor_toJs(obj: CryptoActor): CryptoActorJs = when (obj) {
	...
	else -> throw IllegalArgumentException("""Unknown concrete implementation for com.icure.cardinal.sdk.model.base.CryptoActor: $obj""")
}

public fun cryptoActor_fromJs(obj: CryptoActorJs): CryptoActor = when {
	obj is CryptoActorStubJs || obj.ktClass == "com.icure.cardinal.sdk.model.CryptoActorStub" ->cryptoActorStub_fromJs(obj as com.icure.cardinal.sdk.js.model.CryptoActorStubJs)
	obj is EncryptedPatientJs || obj.ktClass == "com.icure.cardinal.sdk.model.EncryptedPatient" ->patient_fromJs(obj as com.icure.cardinal.sdk.js.model.EncryptedPatientJs)
	obj is DecryptedPatientJs || obj.ktClass == "com.icure.cardinal.sdk.model.DecryptedPatient" ->patient_fromJs(obj as com.icure.cardinal.sdk.js.model.DecryptedPatientJs)
	obj is DeviceJs || obj.ktClass == "com.icure.cardinal.sdk.model.Device" ->device_fromJs(obj as com.icure.cardinal.sdk.js.model.DeviceJs)
	obj is HealthcarePartyJs || obj.ktClass == "com.icure.cardinal.sdk.model.HealthcareParty" ->healthcareParty_fromJs(obj as com.icure.cardinal.sdk.js.model.HealthcarePartyJs)
	else -> throw IllegalArgumentException("""Unknown concrete implementation for com.icure.cardinal.sdk.model.base.CryptoActor: $obj""")
}

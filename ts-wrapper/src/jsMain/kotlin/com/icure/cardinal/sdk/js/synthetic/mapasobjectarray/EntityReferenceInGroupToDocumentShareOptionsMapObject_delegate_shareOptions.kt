...
public external interface EntityReferenceInGroupToDocumentShareOptionsMapObject_delegate_shareOptions {
  public val `delegate`: EntityReferenceInGroupJs

  public val shareOptions: DocumentShareOptionsJs
}

public fun EntityReferenceInGroupToDocumentShareOptionsMapObject_delegate_shareOptions_toJs(ktMap: Map<EntityReferenceInGroup, DocumentShareOptions>): Array<EntityReferenceInGroupToDocumentShareOptionsMapObject_delegate_shareOptions> = ktMap.map { entry ->
...
public fun EntityReferenceInGroupToDocumentShareOptionsMapObject_delegate_shareOptions_fromJs(jsArray: Array<EntityReferenceInGroupToDocumentShareOptionsMapObject_delegate_shareOptions>): Map<EntityReferenceInGroup, DocumentShareOptions> = CheckedConverters.objectArrayToMap(
  jsArray,
  { entry ->

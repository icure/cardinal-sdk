...
public external interface RelatedPersonBasicApiJs {
	...
	public fun matchRelatedPersonsBy(filter: BaseFilterOptionsJs<RelatedPersonJs>): Promise<Array<String>>

	public fun matchRelatedPersonsBySorted(filter: BaseSortableFilterOptionsJs<RelatedPersonJs>): Promise<Array<String>>

	public fun filterRelatedPersonsBy(filter: BaseFilterOptionsJs<RelatedPersonJs>): Promise<PaginatedListIteratorJs<EncryptedRelatedPersonJs>>

	public fun filterRelatedPersonsBySorted(filter: BaseSortableFilterOptionsJs<RelatedPersonJs>): Promise<PaginatedListIteratorJs<EncryptedRelatedPersonJs>>
	...
	public fun createRelatedPersons(entities: Array<EncryptedRelatedPersonJs>): Promise<Array<EncryptedRelatedPersonJs>>

	public fun undeleteRelatedPersonById(id: String, rev: String): Promise<EncryptedRelatedPersonJs>

	public fun undeleteRelatedPersonsByIds(entityIds: Array<StoredDocumentIdentifierJs>): Promise<Array<EncryptedRelatedPersonJs>>

	public fun undeleteRelatedPerson(relatedPerson: RelatedPersonJs): Promise<EncryptedRelatedPersonJs>

	public fun undeleteRelatedPersons(relatedPersons: Array<RelatedPersonJs>): Promise<Array<EncryptedRelatedPersonJs>>

	public fun modifyRelatedPerson(entity: EncryptedRelatedPersonJs): Promise<EncryptedRelatedPersonJs>

	public fun modifyRelatedPersons(entities: Array<EncryptedRelatedPersonJs>): Promise<Array<EncryptedRelatedPersonJs>>

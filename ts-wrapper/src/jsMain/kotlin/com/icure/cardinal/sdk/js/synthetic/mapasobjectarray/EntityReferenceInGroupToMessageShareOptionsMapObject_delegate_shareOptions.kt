...
public fun EntityReferenceInGroupToMessageShareOptionsMapObject_delegate_shareOptions_toJs(ktMap: Map<EntityReferenceInGroup, MessageShareOptions>): Array<EntityReferenceInGroupToMessageShareOptionsMapObject_delegate_shareOptions> = ktMap.map { entry ->
...
public fun EntityReferenceInGroupToMessageShareOptionsMapObject_delegate_shareOptions_fromJs(jsArray: Array<EntityReferenceInGroupToMessageShareOptionsMapObject_delegate_shareOptions>): Map<EntityReferenceInGroup, MessageShareOptions> = CheckedConverters.objectArrayToMap(
  jsArray,
  { entry ->

...
public external interface EntityReferenceInGroupToCalendarItemDelegateOptionsMapObject_delegate_delegateOptions {
  public val `delegate`: EntityReferenceInGroupJs

  public val delegateOptions: CalendarItemDelegateOptionsJs
}

public fun EntityReferenceInGroupToCalendarItemDelegateOptionsMapObject_delegate_delegateOptions_toJs(ktMap: Map<EntityReferenceInGroup, CalendarItemDelegateOptions>): Array<EntityReferenceInGroupToCalendarItemDelegateOptionsMapObject_delegate_delegateOptions> = ktMap.map { entry ->
  ...
  val delegateOptions: CalendarItemDelegateOptionsJs = calendarItemDelegateOptions_toJs(delegateOptionsKt)
  js("{delegate: delegate, delegateOptions: delegateOptions}")
}.toTypedArray()

public fun EntityReferenceInGroupToCalendarItemDelegateOptionsMapObject_delegate_delegateOptions_fromJs(jsArray: Array<EntityReferenceInGroupToCalendarItemDelegateOptionsMapObject_delegate_delegateOptions>): Map<EntityReferenceInGroup, CalendarItemDelegateOptions> = CheckedConverters.objectArrayToMap(
  jsArray,
  { entry ->

...
public external interface EntityReferenceInGroupToAccessLogShareOptionsMapObject_delegate_shareOptions {
  public val `delegate`: EntityReferenceInGroupJs

  public val shareOptions: AccessLogShareOptionsJs
}

public fun EntityReferenceInGroupToAccessLogShareOptionsMapObject_delegate_shareOptions_toJs(ktMap: Map<EntityReferenceInGroup, AccessLogShareOptions>): Array<EntityReferenceInGroupToAccessLogShareOptionsMapObject_delegate_shareOptions> = ktMap.map { entry ->
...
public fun EntityReferenceInGroupToAccessLogShareOptionsMapObject_delegate_shareOptions_fromJs(jsArray: Array<EntityReferenceInGroupToAccessLogShareOptionsMapObject_delegate_shareOptions>): Map<EntityReferenceInGroup, AccessLogShareOptions> = CheckedConverters.objectArrayToMap(
  jsArray,
  { entry ->

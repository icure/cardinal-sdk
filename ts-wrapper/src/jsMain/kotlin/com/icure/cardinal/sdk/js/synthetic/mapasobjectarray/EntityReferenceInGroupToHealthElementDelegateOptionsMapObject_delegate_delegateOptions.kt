...
public external interface EntityReferenceInGroupToHealthElementDelegateOptionsMapObject_delegate_delegateOptions {
  public val `delegate`: EntityReferenceInGroupJs

  public val delegateOptions: HealthElementDelegateOptionsJs
}

public fun EntityReferenceInGroupToHealthElementDelegateOptionsMapObject_delegate_delegateOptions_toJs(ktMap: Map<EntityReferenceInGroup, HealthElementDelegateOptions>): Array<EntityReferenceInGroupToHealthElementDelegateOptionsMapObject_delegate_delegateOptions> = ktMap.map { entry ->
  ...
  val delegateOptions: HealthElementDelegateOptionsJs = healthElementDelegateOptions_toJs(delegateOptionsKt)
  js("{delegate: delegate, delegateOptions: delegateOptions}")
}.toTypedArray()

public fun EntityReferenceInGroupToHealthElementDelegateOptionsMapObject_delegate_delegateOptions_fromJs(jsArray: Array<EntityReferenceInGroupToHealthElementDelegateOptionsMapObject_delegate_delegateOptions>): Map<EntityReferenceInGroup, HealthElementDelegateOptions> = CheckedConverters.objectArrayToMap(
  jsArray,
  { entry ->

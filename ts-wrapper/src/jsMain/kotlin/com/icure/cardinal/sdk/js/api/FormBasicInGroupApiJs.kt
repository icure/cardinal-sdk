...
public external interface FormBasicInGroupApiJs {
	public fun matchFormsBy(groupId: String, filter: BaseFilterOptionsJs<FormJs>): Promise<Array<String>>

	public fun matchFormsBySorted(groupId: String, filter: BaseSortableFilterOptionsJs<FormJs>): Promise<Array<String>>

	public fun filterFormsBy(groupId: String, filter: BaseFilterOptionsJs<FormJs>): Promise<PaginatedListIteratorJs<GroupScopedJs<EncryptedFormJs>>>

	public fun filterFormsBySorted(groupId: String, filter: BaseSortableFilterOptionsJs<FormJs>): Promise<PaginatedListIteratorJs<GroupScopedJs<EncryptedFormJs>>>
	...
	public fun createForm(entity: GroupScopedJs<EncryptedFormJs>): Promise<GroupScopedJs<EncryptedFormJs>>

	public fun createForms(entities: Array<GroupScopedJs<EncryptedFormJs>>): Promise<Array<GroupScopedJs<EncryptedFormJs>>>

	public fun undeleteFormById(entityId: GroupScopedJs<StoredDocumentIdentifierJs>): Promise<GroupScopedJs<EncryptedFormJs>>

	public fun undeleteFormsByIds(entityIds: Array<GroupScopedJs<StoredDocumentIdentifierJs>>): Promise<Array<GroupScopedJs<EncryptedFormJs>>>

	public fun undeleteForm(form: GroupScopedJs<FormJs>): Promise<GroupScopedJs<EncryptedFormJs>>

	public fun undeleteForms(forms: Array<GroupScopedJs<EncryptedFormJs>>): Promise<Array<GroupScopedJs<EncryptedFormJs>>>

	public fun modifyForm(entity: GroupScopedJs<EncryptedFormJs>): Promise<GroupScopedJs<EncryptedFormJs>>

	public fun modifyForms(entities: Array<GroupScopedJs<EncryptedFormJs>>): Promise<Array<GroupScopedJs<EncryptedFormJs>>>

	public fun getForm(groupId: String, entityId: String): Promise<GroupScopedJs<EncryptedFormJs>?>

	public fun getForms(groupId: String, entityIds: Array<String>): Promise<Array<GroupScopedJs<EncryptedFormJs>>>
}

...
public external interface EntityReferenceInGroupToPatientDelegateOptionsMapObject_delegate_delegateOptions {
  public val `delegate`: EntityReferenceInGroupJs

  public val delegateOptions: PatientDelegateOptionsJs
}

public fun EntityReferenceInGroupToPatientDelegateOptionsMapObject_delegate_delegateOptions_toJs(ktMap: Map<EntityReferenceInGroup, PatientDelegateOptions>): Array<EntityReferenceInGroupToPatientDelegateOptionsMapObject_delegate_delegateOptions> = ktMap.map { entry ->
...
public fun EntityReferenceInGroupToPatientDelegateOptionsMapObject_delegate_delegateOptions_fromJs(jsArray: Array<EntityReferenceInGroupToPatientDelegateOptionsMapObject_delegate_delegateOptions>): Map<EntityReferenceInGroup, PatientDelegateOptions> = CheckedConverters.objectArrayToMap(
  jsArray,
  { entry ->

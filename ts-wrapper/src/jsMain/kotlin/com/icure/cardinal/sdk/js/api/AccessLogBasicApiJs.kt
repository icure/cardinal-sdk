...
public external interface AccessLogBasicApiJs {
	...
	public fun matchAccessLogsBySorted(filter: BaseSortableFilterOptionsJs<AccessLogJs>): Promise<Array<String>>

	public fun filterAccessLogsBy(filter: BaseFilterOptionsJs<AccessLogJs>): Promise<PaginatedListIteratorJs<EncryptedAccessLogJs>>

	public fun filterAccessLogsBySorted(filter: BaseSortableFilterOptionsJs<AccessLogJs>): Promise<PaginatedListIteratorJs<EncryptedAccessLogJs>>
	...
	public fun createAccessLogs(entities: Array<EncryptedAccessLogJs>): Promise<Array<EncryptedAccessLogJs>>

	public fun undeleteAccessLogById(id: String, rev: String): Promise<EncryptedAccessLogJs>

	public fun undeleteAccessLogsByIds(entityIds: Array<StoredDocumentIdentifierJs>): Promise<Array<EncryptedAccessLogJs>>
	...
	public fun modifyAccessLogs(entities: Array<EncryptedAccessLogJs>): Promise<Array<EncryptedAccessLogJs>>

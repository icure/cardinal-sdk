...
export interface CalendarItemApi {
	 ...
	 *  @throws IllegalArgumentException if base is not null and has a revision or has encryption metadata.
	 */
	withEncryptionMetadataAndDelegates(base: DecryptedCalendarItem | undefined,
			patient: Patient | undefined, delegates: { [ key: string ]: CalendarItemDelegateOptions },
			options?: { user?: User | undefined, secretId?: SecretIdUseOption, alternateRootDelegateId?: string | undefined }): Promise<DecryptedCalendarItem>;

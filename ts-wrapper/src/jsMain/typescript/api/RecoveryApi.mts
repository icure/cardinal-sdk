...
export interface RecoveryApi {
	 ...
	 *  mode)
	 */
	createRecoveryInfoForAvailableParentKeyPairs(parentId: string,
			options?: { includeAncestorKeys?: boolean, lifetimeSeconds?: number | undefined, recoveryKeyOptions?: RecoveryKeyOptions | undefined }): Promise<RecoveryDataKey>;

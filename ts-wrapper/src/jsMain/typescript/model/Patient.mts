...
export class DecryptedPatient {
	...
	static fromJSON(json: any, ignoreUnknownKeys: boolean = false,
		...
		const res = new DecryptedPatient({
			...
			birthSex: expectStringEnum(extractEntry(jCpy.birthSex, 'birthSex', false, path), true, [...path, ".birthSex"], Gender, 'Gender'),
			mergeToPatientId: expectString(extractEntry(jCpy.mergeToPatientId, 'mergeToPatientId', false, path), true, [...path, ".mergeToPatientId"]),
			mergedIds: expectArray(extractEntry(jCpy.mergedIds, 'mergedIds', false, path), false, [...path, ".mergedIds"], (x0, p0) => expectString(x0, false, p0)),
			alias: expectString(extractEntry(jCpy.alias, 'alias', false, path), true, [...path, ".alias"]),
			active: expectBoolean(extractEntry(jCpy.active, 'active', false, path), false, [...path, ".active"]),
			deactivationReason: expectString(extractEntry(jCpy.deactivationReason, 'deactivationReason', false, path), false, [...path, ".deactivationReason"]),
			deactivationDate: expectNumber(extractEntry(jCpy.deactivationDate, 'deactivationDate', false, path), true, true, [...path, ".deactivationDate"]),
			ssin: expectString(extractEntry(jCpy.ssin, 'ssin', false, path), true, [...path, ".ssin"]),
			maidenName: expectString(extractEntry(jCpy.maidenName, 'maidenName', false, path), true, [...path, ".maidenName"]),
			spouseName: expectString(extractEntry(jCpy.spouseName, 'spouseName', false, path), true, [...path, ".spouseName"]),
			partnerName: expectString(extractEntry(jCpy.partnerName, 'partnerName', false, path), true, [...path, ".partnerName"]),
			personalStatus: expectStringEnum(extractEntry(jCpy.personalStatus, 'personalStatus', false, path), true, [...path, ".personalStatus"], PersonalStatus, 'PersonalStatus'),
			dateOfBirth: expectNumber(extractEntry(jCpy.dateOfBirth, 'dateOfBirth', false, path), true, true, [...path, ".dateOfBirth"]),
			dateOfDeath: expectNumber(extractEntry(jCpy.dateOfDeath, 'dateOfDeath', false, path), true, true, [...path, ".dateOfDeath"]),
			timestampOfLatestEidReading: expectNumber(extractEntry(jCpy.timestampOfLatestEidReading, 'timestampOfLatestEidReading', false, path), true, true, [...path, ".timestampOfLatestEidReading"]),
			placeOfBirth: expectString(extractEntry(jCpy.placeOfBirth, 'placeOfBirth', false, path), true, [...path, ".placeOfBirth"]),
			placeOfDeath: expectString(extractEntry(jCpy.placeOfDeath, 'placeOfDeath', false, path), true, [...path, ".placeOfDeath"]),
			deceased: expectBoolean(extractEntry(jCpy.deceased, 'deceased', false, path), true, [...path, ".deceased"]),
			education: expectString(extractEntry(jCpy.education, 'education', false, path), true, [...path, ".education"]),
			profession: expectString(extractEntry(jCpy.profession, 'profession', false, path), true, [...path, ".profession"]),
			...
			administrativeNote: expectString(extractEntry(jCpy.administrativeNote, 'administrativeNote', false, path), true, [...path, ".administrativeNote"]),
			nationality: expectString(extractEntry(jCpy.nationality, 'nationality', false, path), true, [...path, ".nationality"]),
			race: expectString(extractEntry(jCpy.race, 'race', false, path), true, [...path, ".race"]),
			ethnicity: expectString(extractEntry(jCpy.ethnicity, 'ethnicity', false, path), true, [...path, ".ethnicity"]),
			preferredUserId: expectString(extractEntry(jCpy.preferredUserId, 'preferredUserId', false, path), true, [...path, ".preferredUserId"]),
			...
			insurabilities: expectArray(extractEntry(jCpy.insurabilities, 'insurabilities', false, path), false, [...path, ".insurabilities"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, DecryptedInsurability.fromJSON)),
			partnerships: expectArray(extractEntry(jCpy.partnerships, 'partnerships', false, path), false, [...path, ".partnerships"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, Partnership.fromJSON)),
			patientHealthCareParties: expectArray(extractEntry(jCpy.patientHealthCareParties, 'patientHealthCareParties', false, path), false, [...path, ".patientHealthCareParties"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, DecryptedPatientHealthCareParty.fromJSON)),
			...
			medicalHouseContracts: expectArray(extractEntry(jCpy.medicalHouseContracts, 'medicalHouseContracts', false, path), false, [...path, ".medicalHouseContracts"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, DecryptedMedicalHouseContract.fromJSON)),
			patientProfessions: expectArray(extractEntry(jCpy.patientProfessions, 'patientProfessions', false, path), false, [...path, ".patientProfessions"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, CodeStub.fromJSON)),
			...
			nonDuplicateIds: expectArray(extractEntry(jCpy.nonDuplicateIds, 'nonDuplicateIds', false, path), false, [...path, ".nonDuplicateIds"], (x0, p0) => expectString(x0, false, p0)),
			encryptedAdministrativesDocuments: expectArray(extractEntry(jCpy.encryptedAdministrativesDocuments, 'encryptedAdministrativesDocuments', false, path), false, [...path, ".encryptedAdministrativesDocuments"], (x0, p0) => expectString(x0, false, p0)),
			comment: expectString(extractEntry(jCpy.comment, 'comment', false, path), true, [...path, ".comment"]),
			warning: expectString(extractEntry(jCpy.warning, 'warning', false, path), true, [...path, ".warning"]),
			fatherBirthCountry: expectObject(extractEntry(jCpy.fatherBirthCountry, 'fatherBirthCountry', false, path), true, ignoreUnknownKeys, [...path, ".fatherBirthCountry"], CodeStub.fromJSON),
			birthCountry: expectObject(extractEntry(jCpy.birthCountry, 'birthCountry', false, path), true, ignoreUnknownKeys, [...path, ".birthCountry"], CodeStub.fromJSON),
			nativeCountry: expectObject(extractEntry(jCpy.nativeCountry, 'nativeCountry', false, path), true, ignoreUnknownKeys, [...path, ".nativeCountry"], CodeStub.fromJSON),
			socialStatus: expectObject(extractEntry(jCpy.socialStatus, 'socialStatus', false, path), true, ignoreUnknownKeys, [...path, ".socialStatus"], CodeStub.fromJSON),
			mainSourceOfIncome: expectObject(extractEntry(jCpy.mainSourceOfIncome, 'mainSourceOfIncome', false, path), true, ignoreUnknownKeys, [...path, ".mainSourceOfIncome"], CodeStub.fromJSON),
			schoolingInfos: expectArray(extractEntry(jCpy.schoolingInfos, 'schoolingInfos', false, path), false, [...path, ".schoolingInfos"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, DecryptedSchoolingInfo.fromJSON)),
			employementInfos: expectArray(extractEntry(jCpy.employementInfos, 'employementInfos', false, path), false, [...path, ".employementInfos"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, DecryptedEmploymentInfo.fromJSON)),
			parentId: expectNullish(extractEntry(jCpy.parentId, 'parentId', false, path), [...path, ".parentId"]),
		})
...
export class EncryptedPatient {
	...
	static fromJSON(json: any, ignoreUnknownKeys: boolean = false,
		...
		const res = new EncryptedPatient({
			...
			companyName: expectString(extractEntry(jCpy.companyName, 'companyName', false, path), true, [...path, ".companyName"]),
			languages: expectArray(extractEntry(jCpy.languages, 'languages', false, path), false, [...path, ".languages"], (x0, p0) => expectString(x0, false, p0)),
			addresses: expectArray(extractEntry(jCpy.addresses, 'addresses', false, path), false, [...path, ".addresses"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, EncryptedAddress.fromJSON)),
			civility: expectString(extractEntry(jCpy.civility, 'civility', false, path), true, [...path, ".civility"]),
			gender: expectStringEnum(extractEntry(jCpy.gender, 'gender', false, path), true, [...path, ".gender"], Gender, 'Gender'),
			birthSex: expectStringEnum(extractEntry(jCpy.birthSex, 'birthSex', false, path), true, [...path, ".birthSex"], Gender, 'Gender'),
			mergeToPatientId: expectString(extractEntry(jCpy.mergeToPatientId, 'mergeToPatientId', false, path), true, [...path, ".mergeToPatientId"]),
			...
			picture: decodeBase64(expectString(extractEntry(jCpy.picture, 'picture', false, path), true, [...path, ".picture"]), [...path, ".picture"]),
			externalId: expectString(extractEntry(jCpy.externalId, 'externalId', false, path), true, [...path, ".externalId"]),
			insurabilities: expectArray(extractEntry(jCpy.insurabilities, 'insurabilities', false, path), false, [...path, ".insurabilities"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, EncryptedInsurability.fromJSON)),
			partnerships: expectArray(extractEntry(jCpy.partnerships, 'partnerships', false, path), false, [...path, ".partnerships"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, Partnership.fromJSON)),
			patientHealthCareParties: expectArray(extractEntry(jCpy.patientHealthCareParties, 'patientHealthCareParties', false, path), false, [...path, ".patientHealthCareParties"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, EncryptedPatientHealthCareParty.fromJSON)),
			financialInstitutionInformation: expectArray(extractEntry(jCpy.financialInstitutionInformation, 'financialInstitutionInformation', false, path), false, [...path, ".financialInstitutionInformation"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, EncryptedFinancialInstitutionInformation.fromJSON)),
			medicalHouseContracts: expectArray(extractEntry(jCpy.medicalHouseContracts, 'medicalHouseContracts', false, path), false, [...path, ".medicalHouseContracts"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, EncryptedMedicalHouseContract.fromJSON)),
			patientProfessions: expectArray(extractEntry(jCpy.patientProfessions, 'patientProfessions', false, path), false, [...path, ".patientProfessions"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, CodeStub.fromJSON)),
			parameters: expectMap(
				extractEntry(jCpy.parameters, 'parameters', false, path),
				false,
			...
			socialStatus: expectObject(extractEntry(jCpy.socialStatus, 'socialStatus', false, path), true, ignoreUnknownKeys, [...path, ".socialStatus"], CodeStub.fromJSON),
			mainSourceOfIncome: expectObject(extractEntry(jCpy.mainSourceOfIncome, 'mainSourceOfIncome', false, path), true, ignoreUnknownKeys, [...path, ".mainSourceOfIncome"], CodeStub.fromJSON),
			schoolingInfos: expectArray(extractEntry(jCpy.schoolingInfos, 'schoolingInfos', false, path), false, [...path, ".schoolingInfos"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, EncryptedSchoolingInfo.fromJSON)),
			employementInfos: expectArray(extractEntry(jCpy.employementInfos, 'employementInfos', false, path), false, [...path, ".employementInfos"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, EncryptedEmploymentInfo.fromJSON)),
			parentId: expectNullish(extractEntry(jCpy.parentId, 'parentId', false, path), [...path, ".parentId"]),
		})
		if (!ignoreUnknownKeys) {
			const unused = Object.keys(jCpy)

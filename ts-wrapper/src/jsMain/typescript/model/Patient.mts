 ...
 *  /
 */
export interface Patient extends StoredDocument, ICureDocument<string>, HasMedicalLocation, Person, HasEncryptionMetadata, Encryptable, HasIdentifier, CryptoActor {

...
export class DecryptedInvoicingCode {
	...
	static fromJSON(json: any, ignoreUnknownKeys: boolean = false,
		...
		const res = new DecryptedInvoicingCode({
			id: expectString(extractEntry(jCpy.id, 'id', true, path), true, [...path, ".id"]),
			dateCode: expectNumber(extractEntry(jCpy.dateCode, 'dateCode', false, path), true, true, [...path, ".dateCode"]),
			logicalId: expectString(extractEntry(jCpy.logicalId, 'logicalId', false, path), true, [...path, ".logicalId"]),
			label: expectString(extractEntry(jCpy.label, 'label', false, path), true, [...path, ".label"]),
			...
			tarificationId: expectString(extractEntry(jCpy.tarificationId, 'tarificationId', false, path), true, [...path, ".tarificationId"]),
			...
			amiIntervention: expectNumber(extractEntry(jCpy.amiIntervention, 'amiIntervention', false, path), true, false, [...path, ".amiIntervention"]),
			...
			conventionAmount: expectNumber(extractEntry(jCpy.conventionAmount, 'conventionAmount', false, path), true, false, [...path, ".conventionAmount"]),
			...
			contract: expectString(extractEntry(jCpy.contract, 'contract', false, path), true, [...path, ".contract"]),
			contractDate: expectNumber(extractEntry(jCpy.contractDate, 'contractDate', false, path), true, true, [...path, ".contractDate"]),
			units: expectNumber(extractEntry(jCpy.units, 'units', false, path), true, true, [...path, ".units"]),
			side: expectNumber(extractEntry(jCpy.side, 'side', false, path), true, true, [...path, ".side"]),
			timeOfDay: expectNumber(extractEntry(jCpy.timeOfDay, 'timeOfDay', false, path), true, true, [...path, ".timeOfDay"]),
			eidReadingHour: expectNumber(extractEntry(jCpy.eidReadingHour, 'eidReadingHour', false, path), true, true, [...path, ".eidReadingHour"]),
			eidReadingValue: expectString(extractEntry(jCpy.eidReadingValue, 'eidReadingValue', false, path), true, [...path, ".eidReadingValue"]),
			override3rdPayerCode: expectNumber(extractEntry(jCpy.override3rdPayerCode, 'override3rdPayerCode', false, path), true, true, [...path, ".override3rdPayerCode"]),
			override3rdPayerReason: expectString(extractEntry(jCpy.override3rdPayerReason, 'override3rdPayerReason', false, path), true, [...path, ".override3rdPayerReason"]),
			transplantationCode: expectNumber(extractEntry(jCpy.transplantationCode, 'transplantationCode', false, path), true, true, [...path, ".transplantationCode"]),
			prescriberNorm: expectNumber(extractEntry(jCpy.prescriberNorm, 'prescriberNorm', false, path), true, true, [...path, ".prescriberNorm"]),
			productLabel: expectString(extractEntry(jCpy.productLabel, 'productLabel', false, path), true, [...path, ".productLabel"]),
			percentNorm: expectNumber(extractEntry(jCpy.percentNorm, 'percentNorm', false, path), true, true, [...path, ".percentNorm"]),
			prescriberNihii: expectString(extractEntry(jCpy.prescriberNihii, 'prescriberNihii', false, path), true, [...path, ".prescriberNihii"]),
			relatedCode: expectString(extractEntry(jCpy.relatedCode, 'relatedCode', false, path), true, [...path, ".relatedCode"]),
			prescriptionDate: expectNumber(extractEntry(jCpy.prescriptionDate, 'prescriptionDate', false, path), true, true, [...path, ".prescriptionDate"]),
			derogationMaxNumber: expectNumber(extractEntry(jCpy.derogationMaxNumber, 'derogationMaxNumber', false, path), true, true, [...path, ".derogationMaxNumber"]),
			prescriberSsin: expectString(extractEntry(jCpy.prescriberSsin, 'prescriberSsin', false, path), true, [...path, ".prescriberSsin"]),
			prescriberLastName: expectString(extractEntry(jCpy.prescriberLastName, 'prescriberLastName', false, path), true, [...path, ".prescriberLastName"]),
			prescriberFirstName: expectString(extractEntry(jCpy.prescriberFirstName, 'prescriberFirstName', false, path), true, [...path, ".prescriberFirstName"]),
			prescriberCdHcParty: expectString(extractEntry(jCpy.prescriberCdHcParty, 'prescriberCdHcParty', false, path), true, [...path, ".prescriberCdHcParty"]),
			locationNihii: expectString(extractEntry(jCpy.locationNihii, 'locationNihii', false, path), true, [...path, ".locationNihii"]),
			locationCdHcParty: expectString(extractEntry(jCpy.locationCdHcParty, 'locationCdHcParty', false, path), true, [...path, ".locationCdHcParty"]),
			...
			pending: expectBoolean(extractEntry(jCpy.pending, 'pending', false, path), true, [...path, ".pending"]),
			resent: expectBoolean(extractEntry(jCpy.resent, 'resent', false, path), true, [...path, ".resent"]),
			archived: expectBoolean(extractEntry(jCpy.archived, 'archived', false, path), true, [...path, ".archived"]),
			lost: expectBoolean(extractEntry(jCpy.lost, 'lost', false, path), true, [...path, ".lost"]),
			insuranceJustification: expectNumber(extractEntry(jCpy.insuranceJustification, 'insuranceJustification', false, path), true, true, [...path, ".insuranceJustification"]),
			cancelPatientInterventionReason: expectNumber(extractEntry(jCpy.cancelPatientInterventionReason, 'cancelPatientInterventionReason', false, path), true, true, [...path, ".cancelPatientInterventionReason"]),
			status: expectNumber(extractEntry(jCpy.status, 'status', false, path), true, true, [...path, ".status"]),
			codeLabel: expectString(extractEntry(jCpy.codeLabel, 'codeLabel', false, path), true, [...path, ".codeLabel"]),
			options: expectMap(

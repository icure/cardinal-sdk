...
export class DecryptedInvoice {
	...
	static fromJSON(json: any, ignoreUnknownKeys: boolean = false,
		...
		const res = new DecryptedInvoice({
			...
			invoiceDate: expectNumber(extractEntry(jCpy.invoiceDate, 'invoiceDate', false, path), true, true, [...path, ".invoiceDate"]),
			sentDate: expectNumber(extractEntry(jCpy.sentDate, 'sentDate', false, path), true, true, [...path, ".sentDate"]),
			printedDate: expectNumber(extractEntry(jCpy.printedDate, 'printedDate', false, path), true, true, [...path, ".printedDate"]),
			invoicingCodes: expectArray(extractEntry(jCpy.invoicingCodes, 'invoicingCodes', false, path), false, [...path, ".invoicingCodes"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, DecryptedInvoicingCode.fromJSON)),
			receipts: expectMap(
			...
			recipientType: expectString(extractEntry(jCpy.recipientType, 'recipientType', false, path), true, [...path, ".recipientType"]),
			recipientId: expectString(extractEntry(jCpy.recipientId, 'recipientId', false, path), true, [...path, ".recipientId"]),
			invoiceReference: expectString(extractEntry(jCpy.invoiceReference, 'invoiceReference', false, path), true, [...path, ".invoiceReference"]),
			...
			thirdPartyReference: expectString(extractEntry(jCpy.thirdPartyReference, 'thirdPartyReference', false, path), true, [...path, ".thirdPartyReference"]),
			thirdPartyPaymentJustification: expectString(extractEntry(jCpy.thirdPartyPaymentJustification, 'thirdPartyPaymentJustification', false, path), true, [...path, ".thirdPartyPaymentJustification"]),
			thirdPartyPaymentReason: expectString(extractEntry(jCpy.thirdPartyPaymentReason, 'thirdPartyPaymentReason', false, path), true, [...path, ".thirdPartyPaymentReason"]),
			reason: expectString(extractEntry(jCpy.reason, 'reason', false, path), true, [...path, ".reason"]),
			invoiceType: expectStringEnum(extractEntry(jCpy.invoiceType, 'invoiceType', false, path), true, [...path, ".invoiceType"], InvoiceType, 'InvoiceType'),
			sentMediumType: expectStringEnum(extractEntry(jCpy.sentMediumType, 'sentMediumType', false, path), true, [...path, ".sentMediumType"], MediumType, 'MediumType'),
			interventionType: expectStringEnum(extractEntry(jCpy.interventionType, 'interventionType', false, path), true, [...path, ".interventionType"], InvoiceInterventionType, 'InvoiceInterventionType'),
			...
			payments: expectArray(extractEntry(jCpy.payments, 'payments', false, path), true, [...path, ".payments"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, Payment.fromJSON)),
			gnotionNihii: expectString(extractEntry(jCpy.gnotionNihii, 'gnotionNihii', false, path), true, [...path, ".gnotionNihii"]),
			gnotionSsin: expectString(extractEntry(jCpy.gnotionSsin, 'gnotionSsin', false, path), true, [...path, ".gnotionSsin"]),
			gnotionLastName: expectString(extractEntry(jCpy.gnotionLastName, 'gnotionLastName', false, path), true, [...path, ".gnotionLastName"]),
			gnotionFirstName: expectString(extractEntry(jCpy.gnotionFirstName, 'gnotionFirstName', false, path), true, [...path, ".gnotionFirstName"]),
			gnotionCdHcParty: expectString(extractEntry(jCpy.gnotionCdHcParty, 'gnotionCdHcParty', false, path), true, [...path, ".gnotionCdHcParty"]),
			invoicePeriod: expectNumber(extractEntry(jCpy.invoicePeriod, 'invoicePeriod', false, path), true, true, [...path, ".invoicePeriod"]),
			careProviderType: expectString(extractEntry(jCpy.careProviderType, 'careProviderType', false, path), true, [...path, ".careProviderType"]),
			internshipNihii: expectString(extractEntry(jCpy.internshipNihii, 'internshipNihii', false, path), true, [...path, ".internshipNihii"]),
			internshipSsin: expectString(extractEntry(jCpy.internshipSsin, 'internshipSsin', false, path), true, [...path, ".internshipSsin"]),
			internshipLastName: expectString(extractEntry(jCpy.internshipLastName, 'internshipLastName', false, path), true, [...path, ".internshipLastName"]),
			internshipFirstName: expectString(extractEntry(jCpy.internshipFirstName, 'internshipFirstName', false, path), true, [...path, ".internshipFirstName"]),
			internshipCdHcParty: expectString(extractEntry(jCpy.internshipCdHcParty, 'internshipCdHcParty', false, path), true, [...path, ".internshipCdHcParty"]),
			internshipCbe: expectString(extractEntry(jCpy.internshipCbe, 'internshipCbe', false, path), true, [...path, ".internshipCbe"]),
			supervisorNihii: expectString(extractEntry(jCpy.supervisorNihii, 'supervisorNihii', false, path), true, [...path, ".supervisorNihii"]),
			supervisorSsin: expectString(extractEntry(jCpy.supervisorSsin, 'supervisorSsin', false, path), true, [...path, ".supervisorSsin"]),
			supervisorLastName: expectString(extractEntry(jCpy.supervisorLastName, 'supervisorLastName', false, path), true, [...path, ".supervisorLastName"]),
			supervisorFirstName: expectString(extractEntry(jCpy.supervisorFirstName, 'supervisorFirstName', false, path), true, [...path, ".supervisorFirstName"]),
			supervisorCdHcParty: expectString(extractEntry(jCpy.supervisorCdHcParty, 'supervisorCdHcParty', false, path), true, [...path, ".supervisorCdHcParty"]),
			supervisorCbe: expectString(extractEntry(jCpy.supervisorCbe, 'supervisorCbe', false, path), true, [...path, ".supervisorCbe"]),
			error: expectString(extractEntry(jCpy.error, 'error', false, path), true, [...path, ".error"]),
			encounterLocationName: expectString(extractEntry(jCpy.encounterLocationName, 'encounterLocationName', false, path), true, [...path, ".encounterLocationName"]),
			encounterLocationNihii: expectString(extractEntry(jCpy.encounterLocationNihii, 'encounterLocationNihii', false, path), true, [...path, ".encounterLocationNihii"]),
			encounterLocationNorm: expectNumber(extractEntry(jCpy.encounterLocationNorm, 'encounterLocationNorm', false, path), true, true, [...path, ".encounterLocationNorm"]),
			longDelayJustification: expectNumber(extractEntry(jCpy.longDelayJustification, 'longDelayJustification', false, path), true, true, [...path, ".longDelayJustification"]),
			correctiveInvoiceId: expectString(extractEntry(jCpy.correctiveInvoiceId, 'correctiveInvoiceId', false, path), true, [...path, ".correctiveInvoiceId"]),
			correctedInvoiceId: expectString(extractEntry(jCpy.correctedInvoiceId, 'correctedInvoiceId', false, path), true, [...path, ".correctedInvoiceId"]),
			creditNote: expectBoolean(extractEntry(jCpy.creditNote, 'creditNote', false, path), true, [...path, ".creditNote"]),
			creditNoteRelatedInvoiceId: expectString(extractEntry(jCpy.creditNoteRelatedInvoiceId, 'creditNoteRelatedInvoiceId', false, path), true, [...path, ".creditNoteRelatedInvoiceId"]),
			idDocument: expectObject(extractEntry(jCpy.idDocument, 'idDocument', false, path), true, ignoreUnknownKeys, [...path, ".idDocument"], IdentityDocumentReader.fromJSON),
			admissionDate: expectNumber(extractEntry(jCpy.admissionDate, 'admissionDate', false, path), true, true, [...path, ".admissionDate"]),
			locationNihii: expectString(extractEntry(jCpy.locationNihii, 'locationNihii', false, path), true, [...path, ".locationNihii"]),
			locationService: expectNumber(extractEntry(jCpy.locationService, 'locationService', false, path), true, true, [...path, ".locationService"]),
			cancelReason: expectString(extractEntry(jCpy.cancelReason, 'cancelReason', false, path), true, [...path, ".cancelReason"]),
			cancelDate: expectNumber(extractEntry(jCpy.cancelDate, 'cancelDate', false, path), true, true, [...path, ".cancelDate"]),
			options: expectMap(
...
export class EncryptedInvoice {
	...
	static fromJSON(json: any, ignoreUnknownKeys: boolean = false,
		...
		const res = new EncryptedInvoice({
			...
			sentDate: expectNumber(extractEntry(jCpy.sentDate, 'sentDate', false, path), true, true, [...path, ".sentDate"]),
			printedDate: expectNumber(extractEntry(jCpy.printedDate, 'printedDate', false, path), true, true, [...path, ".printedDate"]),
			invoicingCodes: expectArray(extractEntry(jCpy.invoicingCodes, 'invoicingCodes', false, path), false, [...path, ".invoicingCodes"], (x0, p0) => expectObject(x0, false, ignoreUnknownKeys, p0, EncryptedInvoicingCode.fromJSON)),
			receipts: expectMap(
				extractEntry(jCpy.receipts, 'receipts', false, path),
				false,
				[...path, ".receipts"],

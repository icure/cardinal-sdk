...
public interface RawTopicApi {
	...
	suspend fun getConflictsForEntity(entityId: String): HttpResponse<List<EncryptedTopic>>
	...
	suspend fun matchTopicsByCustomFilter(filter: CustomFilter): HttpResponse<PaginatedList<IdWithValue>>

	suspend fun matchTopicsByCustomFilterInGroup(
		groupId: String,
		filter: CustomFilter,

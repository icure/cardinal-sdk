...
class RawDocumentApiImpl(
	...
	override suspend fun getConflictingEntitiesIds(): HttpResponse<List<String>> =
		get(authProvider) {
			url {
				takeFrom(apiUrl)
				appendPathSegments("rest", "v2", "document", "conflicts")
				parameter("ts", GMTDate().timestamp)
			}
			accept(Application.Json)
		}.wrap()

	override suspend fun getConflictsForEntity(entityId: String): HttpResponse<List<EncryptedDocument>> =
		get(authProvider) {
			url {
				takeFrom(apiUrl)
	...
	): HttpResponse<ConflictResolutionResult<EncryptedDocument>> =
		post(authProvider) {
			url {
				takeFrom(apiUrl)
				appendPathSegments("rest", "v2", "document", "conflicts", "winner")
			}
			contentType(Application.Json)
			accept(Application.Json)
			setBody(request)
	...
	override suspend fun autoSolveConflicts(
		...
		post(authProvider) {
			url {
				takeFrom(apiUrl)
				appendPathSegments("rest", "v2", "document", "conflicts", "solve")
	...
	override suspend fun matchDocumentsByCustomFilter(filter: CustomFilter): HttpResponse<PaginatedList<IdWithValue>> =
		post(authProvider) {
			url {
				takeFrom(apiUrl)
				appendPathSegments("rest", "v2", "document", "matchByCustom")
			}
			contentType(Application.Json)
			accept(Application.Json)
			setBody(filter)
	...
	override suspend fun getConflictingEntitiesIdsInGroup(groupId: String): HttpResponse<List<String>> =
		get(authProvider) {
			url {
				takeFrom(apiUrl)
				appendPathSegments("rest", "v2", "document", "inGroup", groupId, "conflicts")
				parameter("ts", GMTDate().timestamp)
			}
			accept(Application.Json)
		}.wrap()
	...
	override suspend fun declareConflictWinnerInGroup(
		...
		post(authProvider) {
			url {
				takeFrom(apiUrl)
				appendPathSegments("rest", "v2", "document", "inGroup", groupId, "conflicts", "winner")
			}
			contentType(Application.Json)
			accept(Application.Json)
			setBody(request)
	...
	override suspend fun autoSolveConflictsInGroup(
		...
		post(authProvider) {
			url {
				takeFrom(apiUrl)
				appendPathSegments("rest", "v2", "document", "inGroup", groupId, "conflicts", "solve")
				parameter("strategy", strategy?.dtoSerialName)
			}
			contentType(Application.Json)
			accept(Application.Json)
	...
	override suspend fun matchDocumentsByCustomFilterInGroup(
		groupId: String,
		filter: CustomFilter,
		...
		post(authProvider) {
			url {
				takeFrom(apiUrl)
				appendPathSegments("rest", "v2", "document", "inGroup", groupId, "matchByCustom")
			}
			contentType(Application.Json)
			accept(Application.Json)
			setBody(filter)

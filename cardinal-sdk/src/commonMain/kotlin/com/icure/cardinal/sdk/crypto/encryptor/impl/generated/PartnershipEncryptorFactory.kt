...
@InternalIcureApi
internal object PartnershipEncryptorFactory : EntityEncryptorFactory<EncryptedPartnership, DecryptedPartnership> {
	override val empty: EntityEncryptor<EncryptedPartnership, DecryptedPartnership> =
		object : EntityEncryptor<EncryptedPartnership, DecryptedPartnership> {
	...
	override fun create(
		...
		require(manifest.currentExtensionsManifest == null) {
			"Partnership is not Extendable and does not support extensions encryption, but its manifest defines a currentExtensionsManifest."
		}

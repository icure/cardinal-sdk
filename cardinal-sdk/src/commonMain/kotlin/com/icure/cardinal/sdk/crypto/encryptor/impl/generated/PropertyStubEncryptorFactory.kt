...
@InternalIcureApi
internal object PropertyStubEncryptorFactory : EntityEncryptorFactory<EncryptedPropertyStub, DecryptedPropertyStub> {
	override val empty: EntityEncryptor<EncryptedPropertyStub, DecryptedPropertyStub> =
		object : EntityEncryptor<EncryptedPropertyStub, DecryptedPropertyStub> {
	...
	override fun create(
		...
		require(manifest.currentExtensionsManifest == null) {
			"PropertyStub is not Extendable and does not support extensions encryption, but its manifest defines a currentExtensionsManifest."
		}

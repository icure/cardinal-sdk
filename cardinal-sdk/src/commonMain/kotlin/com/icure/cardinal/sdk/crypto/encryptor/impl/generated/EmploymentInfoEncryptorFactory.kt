...
@InternalIcureApi
internal object EmploymentInfoEncryptorFactory : EntityEncryptorFactory<EncryptedEmploymentInfo, DecryptedEmploymentInfo> {
	override val empty: EntityEncryptor<EncryptedEmploymentInfo, DecryptedEmploymentInfo> =
		object : EntityEncryptor<EncryptedEmploymentInfo, DecryptedEmploymentInfo> {
	...
	override fun create(
		...
		require(manifest.currentExtensionsManifest == null) {
			"EmploymentInfo is not Extendable and does not support extensions encryption, but its manifest defines a currentExtensionsManifest."
		}

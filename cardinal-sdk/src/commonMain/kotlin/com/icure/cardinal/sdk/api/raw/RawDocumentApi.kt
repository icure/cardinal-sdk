...
public interface RawDocumentApi {
	...
	suspend fun getConflictsForEntity(entityId: String): HttpResponse<List<EncryptedDocument>>
	...
	suspend fun matchDocumentsByCustomFilter(filter: CustomFilter): HttpResponse<PaginatedList<IdWithValue>>
	// endregion
	...
	suspend fun matchDocumentsByCustomFilterInGroup(
		groupId: String,
		filter: CustomFilter,

...
class GetSecretIdsTest : StringSpec({
	...
	"Get secret ids method should provide the data owners that are known to have access to each available secret id".config(enabled = DEFAULT_ENABLED && LOCAL_ENV_ONLY) {

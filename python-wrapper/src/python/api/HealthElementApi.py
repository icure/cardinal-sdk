...
from cardinal_sdk.model import DecryptedHealthElement, Patient, User, AccessLevel, SecretIdUseOption, SecretIdUseOptionUseAnySharedWithParent, serialize_patient, serialize_secret_id_use_option, HealthElementDelegateOptions, HealthElement, serialize_health_element, EntityReferenceInGroup, EncryptedHealthElement, deserialize_health_element, StoredDocumentIdentifier, HealthElementShareOptions, SubscriptionEventType, EntitySubscriptionConfiguration, GroupScoped
...
class HealthElementApi:
	...
	async def with_encryption_metadata_async(self, base: Optional[DecryptedHealthElement], patient: Patient, user: Optional[User] = None, delegates: dict[str, AccessLevel] = {}, secret_id: SecretIdUseOption = SecretIdUseOptionUseAnySharedWithParent(), alternate_root_delegate_id: Optional[str] = None) -> DecryptedHealthElement:
	...
	def with_encryption_metadata_blocking(self, base: Optional[DecryptedHealthElement], patient: Patient, user: Optional[User] = None, delegates: dict[str, AccessLevel] = {}, secret_id: SecretIdUseOption = SecretIdUseOptionUseAnySharedWithParent(), alternate_root_delegate_id: Optional[str] = None) -> DecryptedHealthElement:
		payload = {
			"base": base.__serialize__() if base is not None else None,
			"patient": serialize_patient(patient),
			"user": user.__serialize__() if user is not None else None,
	...
	async def with_encryption_metadata_and_delegates_async(self, base: Optional[DecryptedHealthElement], patient: Patient, delegates: dict[str, HealthElementDelegateOptions], user: Optional[User] = None, secret_id: SecretIdUseOption = SecretIdUseOptionUseAnySharedWithParent(), alternate_root_delegate_id: Optional[str] = None) -> DecryptedHealthElement:
		def do_decode(raw_result):
			return DecryptedHealthElement._deserialize(raw_result)
		payload = {
			"base": base.__serialize__() if base is not None else None,
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.HealthElementApi.withEncryptionMetadataAndDelegatesAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def with_encryption_metadata_and_delegates_blocking(self, base: Optional[DecryptedHealthElement], patient: Patient, delegates: dict[str, HealthElementDelegateOptions], user: Optional[User] = None, secret_id: SecretIdUseOption = SecretIdUseOptionUseAnySharedWithParent(), alternate_root_delegate_id: Optional[str] = None) -> DecryptedHealthElement:
		payload = {
			"base": base.__serialize__() if base is not None else None,
			"patient": serialize_patient(patient),
			"delegates": {k0: v0.__serialize__() for k0, v0 in delegates.items()},
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.HealthElementApi.withEncryptionMetadataAndDelegatesBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
...
class HealthElementApiInGroup:
	...
	async def with_encryption_metadata_and_delegates_async(self, entity_group_id: str, base: Optional[DecryptedHealthElement], patient: GroupScoped[Patient], delegates: dict[EntityReferenceInGroup, HealthElementDelegateOptions], user: Optional[User] = None, secret_id: SecretIdUseOption = SecretIdUseOptionUseAnySharedWithParent(), alternate_root_delegate_reference: Optional[EntityReferenceInGroup] = None) -> GroupScoped[DecryptedHealthElement]:
		def do_decode(raw_result):
			return GroupScoped._deserialize(raw_result, lambda x1: DecryptedHealthElement._deserialize(x1))
		payload = {
			"entityGroupId": entity_group_id,
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.HealthElementApi.inGroup.withEncryptionMetadataAndDelegatesAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def with_encryption_metadata_and_delegates_blocking(self, entity_group_id: str, base: Optional[DecryptedHealthElement], patient: GroupScoped[Patient], delegates: dict[EntityReferenceInGroup, HealthElementDelegateOptions], user: Optional[User] = None, secret_id: SecretIdUseOption = SecretIdUseOptionUseAnySharedWithParent(), alternate_root_delegate_reference: Optional[EntityReferenceInGroup] = None) -> GroupScoped[DecryptedHealthElement]:
		payload = {
			"entityGroupId": entity_group_id,
			"base": base.__serialize__() if base is not None else None,
			"patient": patient.__serialize__(lambda x0: serialize_patient(x0)),
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.HealthElementApi.inGroup.withEncryptionMetadataAndDelegatesBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))

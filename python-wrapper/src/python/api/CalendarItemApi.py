...
from cardinal_sdk.model import DecryptedCalendarItem, Patient, User, AccessLevel, SecretIdUseOption, SecretIdUseOptionUseAnySharedWithParent, serialize_patient, serialize_secret_id_use_option, CalendarItemDelegateOptions, CalendarItem, serialize_calendar_item, EntityReferenceInGroup, EncryptedCalendarItem, deserialize_calendar_item, CalendarItemOccupancy, StoredDocumentIdentifier, CalendarItemShareOptions, SubscriptionEventType, EntitySubscriptionConfiguration, GroupScoped
...
class CalendarItemApi:
	...
	async def with_encryption_metadata_and_delegates_async(self, base: Optional[DecryptedCalendarItem], patient: Optional[Patient], delegates: dict[str, CalendarItemDelegateOptions], user: Optional[User] = None, secret_id: SecretIdUseOption = SecretIdUseOptionUseAnySharedWithParent(), alternate_root_delegate_id: Optional[str] = None) -> DecryptedCalendarItem:
		def do_decode(raw_result):
			return DecryptedCalendarItem._deserialize(raw_result)
		payload = {
			"base": base.__serialize__() if base is not None else None,
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.withEncryptionMetadataAndDelegatesAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def with_encryption_metadata_and_delegates_blocking(self, base: Optional[DecryptedCalendarItem], patient: Optional[Patient], delegates: dict[str, CalendarItemDelegateOptions], user: Optional[User] = None, secret_id: SecretIdUseOption = SecretIdUseOptionUseAnySharedWithParent(), alternate_root_delegate_id: Optional[str] = None) -> DecryptedCalendarItem:
		payload = {
			"base": base.__serialize__() if base is not None else None,
			"patient": serialize_patient(patient) if patient is not None else None,
			"delegates": {k0: v0.__serialize__() for k0, v0 in delegates.items()},
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.withEncryptionMetadataAndDelegatesBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def get_calendar_items_occupancy_by_period_for_self_async(self, start_date: int, end_date: int, extension_in_days: Optional[int]) -> list[CalendarItemOccupancy]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.getCalendarItemsOccupancyByPeriodForSelfAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def get_calendar_items_occupancy_by_period_for_self_blocking(self, start_date: int, end_date: int, extension_in_days: Optional[int]) -> list[CalendarItemOccupancy]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.getCalendarItemsOccupancyByPeriodForSelfBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def get_calendar_items_occupancy_by_period_for_healthcare_party_async(self, start_date: int, end_date: int, hc_party_id: str, extension_in_days: Optional[int]) -> list[CalendarItemOccupancy]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.getCalendarItemsOccupancyByPeriodForHealthcarePartyAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def get_calendar_items_occupancy_by_period_for_healthcare_party_blocking(self, start_date: int, end_date: int, hc_party_id: str, extension_in_days: Optional[int]) -> list[CalendarItemOccupancy]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.getCalendarItemsOccupancyByPeriodForHealthcarePartyBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def get_calendar_items_occupancy_by_period_and_agenda_id_async(self, start_date: int, end_date: int, agenda_id: str, extension_in_days: Optional[int]) -> list[CalendarItemOccupancy]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.getCalendarItemsOccupancyByPeriodAndAgendaIdAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def get_calendar_items_occupancy_by_period_and_agenda_id_blocking(self, start_date: int, end_date: int, agenda_id: str, extension_in_days: Optional[int]) -> list[CalendarItemOccupancy]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.getCalendarItemsOccupancyByPeriodAndAgendaIdBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def purge_calendar_items_by_ids_async(self, entity_ids: list[StoredDocumentIdentifier]) -> list[StoredDocumentIdentifier]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.purgeCalendarItemsByIdsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def purge_calendar_items_by_ids_blocking(self, entity_ids: list[StoredDocumentIdentifier]) -> list[StoredDocumentIdentifier]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.purgeCalendarItemsByIdsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def purge_calendar_items_async(self, calendar_items: list[CalendarItem]) -> list[StoredDocumentIdentifier]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.purgeCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def purge_calendar_items_blocking(self, calendar_items: list[CalendarItem]) -> list[StoredDocumentIdentifier]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.purgeCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def create_calendar_items_async(self, entities: list[DecryptedCalendarItem]) -> list[DecryptedCalendarItem]:
		def do_decode(raw_result):
			return [DecryptedCalendarItem._deserialize(x1) for x1 in raw_result]
		payload = {
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.createCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def create_calendar_items_blocking(self, entities: list[DecryptedCalendarItem]) -> list[DecryptedCalendarItem]:
		payload = {
			"entities": [x0.__serialize__() for x0 in entities],
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.createCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def book_calendar_item_checking_availability_async(self, entity: DecryptedCalendarItem) -> DecryptedCalendarItem:
		def do_decode(raw_result):
			return DecryptedCalendarItem._deserialize(raw_result)
		payload = {
			"entity": entity.__serialize__(),
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.bookCalendarItemCheckingAvailabilityAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def book_calendar_item_checking_availability_blocking(self, entity: DecryptedCalendarItem) -> DecryptedCalendarItem:
		payload = {
			"entity": entity.__serialize__(),
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.bookCalendarItemCheckingAvailabilityBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_items_by_ids_async(self, entity_ids: list[StoredDocumentIdentifier]) -> list[DecryptedCalendarItem]:
		def do_decode(raw_result):
			return [DecryptedCalendarItem._deserialize(x1) for x1 in raw_result]
		payload = {
			"entityIds": [x0.__serialize__() for x0 in entity_ids],
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.undeleteCalendarItemsByIdsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def undelete_calendar_items_by_ids_blocking(self, entity_ids: list[StoredDocumentIdentifier]) -> list[DecryptedCalendarItem]:
		payload = {
			"entityIds": [x0.__serialize__() for x0 in entity_ids],
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.undeleteCalendarItemsByIdsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_items_async(self, calendar_items: list[CalendarItem]) -> list[DecryptedCalendarItem]:
		def do_decode(raw_result):
			return [DecryptedCalendarItem._deserialize(x1) for x1 in raw_result]
		payload = {
			"calendarItems": [serialize_calendar_item(x0) for x0 in calendar_items],
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.undeleteCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def undelete_calendar_items_blocking(self, calendar_items: list[CalendarItem]) -> list[DecryptedCalendarItem]:
		payload = {
			"calendarItems": [serialize_calendar_item(x0) for x0 in calendar_items],
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.undeleteCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def modify_calendar_items_async(self, entities: list[DecryptedCalendarItem]) -> list[DecryptedCalendarItem]:
		def do_decode(raw_result):
			return [DecryptedCalendarItem._deserialize(x1) for x1 in raw_result]
		payload = {
			"entities": [x0.__serialize__() for x0 in entities],
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.modifyCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def modify_calendar_items_blocking(self, entities: list[DecryptedCalendarItem]) -> list[DecryptedCalendarItem]:
		payload = {
			"entities": [x0.__serialize__() for x0 in entities],
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.modifyCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
...
class CalendarItemApiEncrypted:
	...
	async def create_calendar_items_async(self, entities: list[EncryptedCalendarItem]) -> list[EncryptedCalendarItem]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.encrypted.createCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def create_calendar_items_blocking(self, entities: list[EncryptedCalendarItem]) -> list[EncryptedCalendarItem]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.encrypted.createCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def book_calendar_item_checking_availability_async(self, entity: EncryptedCalendarItem) -> EncryptedCalendarItem:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.encrypted.bookCalendarItemCheckingAvailabilityAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def book_calendar_item_checking_availability_blocking(self, entity: EncryptedCalendarItem) -> EncryptedCalendarItem:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.encrypted.bookCalendarItemCheckingAvailabilityBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_items_by_ids_async(self, entity_ids: list[StoredDocumentIdentifier]) -> list[EncryptedCalendarItem]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.encrypted.undeleteCalendarItemsByIdsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def undelete_calendar_items_by_ids_blocking(self, entity_ids: list[StoredDocumentIdentifier]) -> list[EncryptedCalendarItem]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.encrypted.undeleteCalendarItemsByIdsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_items_async(self, calendar_items: list[CalendarItem]) -> list[EncryptedCalendarItem]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.encrypted.undeleteCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def undelete_calendar_items_blocking(self, calendar_items: list[CalendarItem]) -> list[EncryptedCalendarItem]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.encrypted.undeleteCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def modify_calendar_items_async(self, entities: list[EncryptedCalendarItem]) -> list[EncryptedCalendarItem]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.encrypted.modifyCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def modify_calendar_items_blocking(self, entities: list[EncryptedCalendarItem]) -> list[EncryptedCalendarItem]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.encrypted.modifyCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
...
class CalendarItemApiTryAndRecover:
	...
	async def create_calendar_items_async(self, entities: list[CalendarItem]) -> list[CalendarItem]:
		def do_decode(raw_result):
			return [deserialize_calendar_item(x1) for x1 in raw_result]
		payload = {
			"entities": [serialize_calendar_item(x0) for x0 in entities],
		}
		return await execute_async_method_job(
			self.cardinal_sdk._executor,
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.tryAndRecover.createCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def create_calendar_items_blocking(self, entities: list[CalendarItem]) -> list[CalendarItem]:
		payload = {
			"entities": [serialize_calendar_item(x0) for x0 in entities],
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.tryAndRecover.createCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def book_calendar_item_checking_availability_async(self, entity: CalendarItem) -> CalendarItem:
		def do_decode(raw_result):
			return deserialize_calendar_item(raw_result)
		payload = {
			"entity": serialize_calendar_item(entity),
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.tryAndRecover.bookCalendarItemCheckingAvailabilityAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def book_calendar_item_checking_availability_blocking(self, entity: CalendarItem) -> CalendarItem:
		payload = {
			"entity": serialize_calendar_item(entity),
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.tryAndRecover.bookCalendarItemCheckingAvailabilityBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_items_by_ids_async(self, entity_ids: list[StoredDocumentIdentifier]) -> list[CalendarItem]:
		def do_decode(raw_result):
			return [deserialize_calendar_item(x1) for x1 in raw_result]
		payload = {
			"entityIds": [x0.__serialize__() for x0 in entity_ids],
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.tryAndRecover.undeleteCalendarItemsByIdsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def undelete_calendar_items_by_ids_blocking(self, entity_ids: list[StoredDocumentIdentifier]) -> list[CalendarItem]:
		payload = {
			"entityIds": [x0.__serialize__() for x0 in entity_ids],
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.tryAndRecover.undeleteCalendarItemsByIdsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_items_async(self, calendar_items: list[CalendarItem]) -> list[CalendarItem]:
		def do_decode(raw_result):
			return [deserialize_calendar_item(x1) for x1 in raw_result]
		payload = {
			"calendarItems": [serialize_calendar_item(x0) for x0 in calendar_items],
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.tryAndRecover.undeleteCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def undelete_calendar_items_blocking(self, calendar_items: list[CalendarItem]) -> list[CalendarItem]:
		payload = {
			"calendarItems": [serialize_calendar_item(x0) for x0 in calendar_items],
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.tryAndRecover.undeleteCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def modify_calendar_items_async(self, entities: list[CalendarItem]) -> list[CalendarItem]:
		def do_decode(raw_result):
			return [deserialize_calendar_item(x1) for x1 in raw_result]
		payload = {
			"entities": [serialize_calendar_item(x0) for x0 in entities],
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.tryAndRecover.modifyCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def modify_calendar_items_blocking(self, entities: list[CalendarItem]) -> list[CalendarItem]:
		payload = {
			"entities": [serialize_calendar_item(x0) for x0 in entities],
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.tryAndRecover.modifyCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
...
class CalendarItemApiInGroup:
	...
	async def with_encryption_metadata_and_delegates_async(self, entity_group_id: str, base: Optional[DecryptedCalendarItem], patient: Optional[GroupScoped[Patient]], delegates: dict[EntityReferenceInGroup, CalendarItemDelegateOptions], user: Optional[User], secret_id: SecretIdUseOption = SecretIdUseOptionUseAnySharedWithParent(), alternate_root_delegate_reference: Optional[EntityReferenceInGroup] = None) -> GroupScoped[DecryptedCalendarItem]:
		def do_decode(raw_result):
			return GroupScoped._deserialize(raw_result, lambda x1: DecryptedCalendarItem._deserialize(x1))
		payload = {
			"entityGroupId": entity_group_id,
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.withEncryptionMetadataAndDelegatesAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def with_encryption_metadata_and_delegates_blocking(self, entity_group_id: str, base: Optional[DecryptedCalendarItem], patient: Optional[GroupScoped[Patient]], delegates: dict[EntityReferenceInGroup, CalendarItemDelegateOptions], user: Optional[User], secret_id: SecretIdUseOption = SecretIdUseOptionUseAnySharedWithParent(), alternate_root_delegate_reference: Optional[EntityReferenceInGroup] = None) -> GroupScoped[DecryptedCalendarItem]:
		payload = {
			"entityGroupId": entity_group_id,
			"base": base.__serialize__() if base is not None else None,
			"patient": patient.__serialize__(lambda x0: serialize_patient(x0)) if patient is not None else None,
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.withEncryptionMetadataAndDelegatesBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def get_calendar_items_occupancy_by_period_for_self_async(self, group_id: str, start_date: int, end_date: int, extension_in_days: Optional[int]) -> list[CalendarItemOccupancy]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.getCalendarItemsOccupancyByPeriodForSelfAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def get_calendar_items_occupancy_by_period_for_self_blocking(self, group_id: str, start_date: int, end_date: int, extension_in_days: Optional[int]) -> list[CalendarItemOccupancy]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.getCalendarItemsOccupancyByPeriodForSelfBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def get_calendar_items_occupancy_by_period_for_healthcare_party_async(self, group_id: str, start_date: int, end_date: int, hc_party_id: str, extension_in_days: Optional[int]) -> list[CalendarItemOccupancy]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.getCalendarItemsOccupancyByPeriodForHealthcarePartyAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def get_calendar_items_occupancy_by_period_for_healthcare_party_blocking(self, group_id: str, start_date: int, end_date: int, hc_party_id: str, extension_in_days: Optional[int]) -> list[CalendarItemOccupancy]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.getCalendarItemsOccupancyByPeriodForHealthcarePartyBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def get_calendar_items_occupancy_by_period_and_agenda_id_async(self, group_id: str, start_date: int, end_date: int, agenda_id: str, extension_in_days: Optional[int]) -> list[CalendarItemOccupancy]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.getCalendarItemsOccupancyByPeriodAndAgendaIdAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def get_calendar_items_occupancy_by_period_and_agenda_id_blocking(self, group_id: str, start_date: int, end_date: int, agenda_id: str, extension_in_days: Optional[int]) -> list[CalendarItemOccupancy]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.getCalendarItemsOccupancyByPeriodAndAgendaIdBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def purge_calendar_item_by_id_async(self, entity_id: GroupScoped[StoredDocumentIdentifier]) -> None:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.purgeCalendarItemByIdAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def purge_calendar_item_by_id_blocking(self, entity_id: GroupScoped[StoredDocumentIdentifier]) -> None:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.purgeCalendarItemByIdBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def purge_calendar_items_by_ids_async(self, entity_ids: list[GroupScoped[StoredDocumentIdentifier]]) -> list[GroupScoped[StoredDocumentIdentifier]]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.purgeCalendarItemsByIdsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def purge_calendar_items_by_ids_blocking(self, entity_ids: list[GroupScoped[StoredDocumentIdentifier]]) -> list[GroupScoped[StoredDocumentIdentifier]]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.purgeCalendarItemsByIdsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def purge_calendar_item_async(self, calendar_item: GroupScoped[CalendarItem]) -> None:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.purgeCalendarItemAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def purge_calendar_item_blocking(self, calendar_item: GroupScoped[CalendarItem]) -> None:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.purgeCalendarItemBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def purge_calendar_items_async(self, calendar_items: list[GroupScoped[CalendarItem]]) -> list[GroupScoped[StoredDocumentIdentifier]]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.purgeCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def purge_calendar_items_blocking(self, calendar_items: list[GroupScoped[CalendarItem]]) -> list[GroupScoped[StoredDocumentIdentifier]]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.purgeCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def create_calendar_items_async(self, entities: list[GroupScoped[DecryptedCalendarItem]]) -> list[GroupScoped[DecryptedCalendarItem]]:
		def do_decode(raw_result):
			return [GroupScoped._deserialize(x1, lambda x2: DecryptedCalendarItem._deserialize(x2)) for x1 in raw_result]
		payload = {
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.createCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def create_calendar_items_blocking(self, entities: list[GroupScoped[DecryptedCalendarItem]]) -> list[GroupScoped[DecryptedCalendarItem]]:
		payload = {
			"entities": [x0.__serialize__(lambda x1: x1.__serialize__()) for x0 in entities],
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.createCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_item_by_id_async(self, entity_id: GroupScoped[StoredDocumentIdentifier]) -> GroupScoped[DecryptedCalendarItem]:
		def do_decode(raw_result):
			return GroupScoped._deserialize(raw_result, lambda x1: DecryptedCalendarItem._deserialize(x1))
		payload = {
			"entityId": entity_id.__serialize__(lambda x0: x0.__serialize__()),
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.undeleteCalendarItemByIdAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def undelete_calendar_item_by_id_blocking(self, entity_id: GroupScoped[StoredDocumentIdentifier]) -> GroupScoped[DecryptedCalendarItem]:
		payload = {
			"entityId": entity_id.__serialize__(lambda x0: x0.__serialize__()),
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.undeleteCalendarItemByIdBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_items_by_ids_async(self, entity_ids: list[GroupScoped[StoredDocumentIdentifier]]) -> list[GroupScoped[DecryptedCalendarItem]]:
		def do_decode(raw_result):
			return [GroupScoped._deserialize(x1, lambda x2: DecryptedCalendarItem._deserialize(x2)) for x1 in raw_result]
		payload = {
			"entityIds": [x0.__serialize__(lambda x1: x1.__serialize__()) for x0 in entity_ids],
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.undeleteCalendarItemsByIdsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def undelete_calendar_items_by_ids_blocking(self, entity_ids: list[GroupScoped[StoredDocumentIdentifier]]) -> list[GroupScoped[DecryptedCalendarItem]]:
		payload = {
			"entityIds": [x0.__serialize__(lambda x1: x1.__serialize__()) for x0 in entity_ids],
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.undeleteCalendarItemsByIdsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_item_async(self, calendar_item: GroupScoped[CalendarItem]) -> GroupScoped[DecryptedCalendarItem]:
		def do_decode(raw_result):
			return GroupScoped._deserialize(raw_result, lambda x1: DecryptedCalendarItem._deserialize(x1))
		payload = {
			"calendarItem": calendar_item.__serialize__(lambda x0: serialize_calendar_item(x0)),
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.undeleteCalendarItemAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def undelete_calendar_item_blocking(self, calendar_item: GroupScoped[CalendarItem]) -> GroupScoped[DecryptedCalendarItem]:
		payload = {
			"calendarItem": calendar_item.__serialize__(lambda x0: serialize_calendar_item(x0)),
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.undeleteCalendarItemBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_items_async(self, calendar_items: list[GroupScoped[DecryptedCalendarItem]]) -> list[GroupScoped[DecryptedCalendarItem]]:
		def do_decode(raw_result):
			return [GroupScoped._deserialize(x1, lambda x2: DecryptedCalendarItem._deserialize(x2)) for x1 in raw_result]
		payload = {
			"calendarItems": [x0.__serialize__(lambda x1: x1.__serialize__()) for x0 in calendar_items],
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.undeleteCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def undelete_calendar_items_blocking(self, calendar_items: list[GroupScoped[DecryptedCalendarItem]]) -> list[GroupScoped[DecryptedCalendarItem]]:
		payload = {
			"calendarItems": [x0.__serialize__(lambda x1: x1.__serialize__()) for x0 in calendar_items],
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.undeleteCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def modify_calendar_items_async(self, entities: list[GroupScoped[DecryptedCalendarItem]]) -> list[GroupScoped[DecryptedCalendarItem]]:
		def do_decode(raw_result):
			return [GroupScoped._deserialize(x1, lambda x2: DecryptedCalendarItem._deserialize(x2)) for x1 in raw_result]
		payload = {
			"entities": [x0.__serialize__(lambda x1: x1.__serialize__()) for x0 in entities],
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.modifyCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def modify_calendar_items_blocking(self, entities: list[GroupScoped[DecryptedCalendarItem]]) -> list[GroupScoped[DecryptedCalendarItem]]:
		payload = {
			"entities": [x0.__serialize__(lambda x1: x1.__serialize__()) for x0 in entities],
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.modifyCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
...
class CalendarItemApiInGroupEncrypted:
	...
	async def create_calendar_items_async(self, entities: list[GroupScoped[EncryptedCalendarItem]]) -> list[GroupScoped[EncryptedCalendarItem]]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.encrypted.createCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def create_calendar_items_blocking(self, entities: list[GroupScoped[EncryptedCalendarItem]]) -> list[GroupScoped[EncryptedCalendarItem]]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.encrypted.createCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_item_by_id_async(self, entity_id: GroupScoped[StoredDocumentIdentifier]) -> GroupScoped[EncryptedCalendarItem]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.encrypted.undeleteCalendarItemByIdAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def undelete_calendar_item_by_id_blocking(self, entity_id: GroupScoped[StoredDocumentIdentifier]) -> GroupScoped[EncryptedCalendarItem]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.encrypted.undeleteCalendarItemByIdBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_items_by_ids_async(self, entity_ids: list[GroupScoped[StoredDocumentIdentifier]]) -> list[GroupScoped[EncryptedCalendarItem]]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.encrypted.undeleteCalendarItemsByIdsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def undelete_calendar_items_by_ids_blocking(self, entity_ids: list[GroupScoped[StoredDocumentIdentifier]]) -> list[GroupScoped[EncryptedCalendarItem]]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.encrypted.undeleteCalendarItemsByIdsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_item_async(self, calendar_item: GroupScoped[CalendarItem]) -> GroupScoped[EncryptedCalendarItem]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.encrypted.undeleteCalendarItemAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def undelete_calendar_item_blocking(self, calendar_item: GroupScoped[CalendarItem]) -> GroupScoped[EncryptedCalendarItem]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.encrypted.undeleteCalendarItemBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_items_async(self, calendar_items: list[GroupScoped[EncryptedCalendarItem]]) -> list[GroupScoped[EncryptedCalendarItem]]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.encrypted.undeleteCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def undelete_calendar_items_blocking(self, calendar_items: list[GroupScoped[EncryptedCalendarItem]]) -> list[GroupScoped[EncryptedCalendarItem]]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.encrypted.undeleteCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def modify_calendar_items_async(self, entities: list[GroupScoped[EncryptedCalendarItem]]) -> list[GroupScoped[EncryptedCalendarItem]]:
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.encrypted.modifyCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	def modify_calendar_items_blocking(self, entities: list[GroupScoped[EncryptedCalendarItem]]) -> list[GroupScoped[EncryptedCalendarItem]]:
		...
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.encrypted.modifyCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
...
class CalendarItemApiInGroupTryAndRecover:
	...
	async def create_calendar_items_async(self, entities: list[GroupScoped[CalendarItem]]) -> list[GroupScoped[CalendarItem]]:
		def do_decode(raw_result):
			return [GroupScoped._deserialize(x1, lambda x2: deserialize_calendar_item(x2)) for x1 in raw_result]
		payload = {
			"entities": [x0.__serialize__(lambda x1: serialize_calendar_item(x1)) for x0 in entities],
		}
		return await execute_async_method_job(
			self.cardinal_sdk._executor,
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.tryAndRecover.createCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def create_calendar_items_blocking(self, entities: list[GroupScoped[CalendarItem]]) -> list[GroupScoped[CalendarItem]]:
		payload = {
			"entities": [x0.__serialize__(lambda x1: serialize_calendar_item(x1)) for x0 in entities],
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.tryAndRecover.createCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_item_by_id_async(self, entity_id: GroupScoped[StoredDocumentIdentifier]) -> GroupScoped[CalendarItem]:
		def do_decode(raw_result):
			return GroupScoped._deserialize(raw_result, lambda x1: deserialize_calendar_item(x1))
		payload = {
			"entityId": entity_id.__serialize__(lambda x0: x0.__serialize__()),
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.tryAndRecover.undeleteCalendarItemByIdAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def undelete_calendar_item_by_id_blocking(self, entity_id: GroupScoped[StoredDocumentIdentifier]) -> GroupScoped[CalendarItem]:
		payload = {
			"entityId": entity_id.__serialize__(lambda x0: x0.__serialize__()),
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.tryAndRecover.undeleteCalendarItemByIdBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_items_by_ids_async(self, entity_ids: list[GroupScoped[StoredDocumentIdentifier]]) -> list[GroupScoped[CalendarItem]]:
		def do_decode(raw_result):
			return [GroupScoped._deserialize(x1, lambda x2: deserialize_calendar_item(x2)) for x1 in raw_result]
		payload = {
			"entityIds": [x0.__serialize__(lambda x1: x1.__serialize__()) for x0 in entity_ids],
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.tryAndRecover.undeleteCalendarItemsByIdsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def undelete_calendar_items_by_ids_blocking(self, entity_ids: list[GroupScoped[StoredDocumentIdentifier]]) -> list[GroupScoped[CalendarItem]]:
		payload = {
			"entityIds": [x0.__serialize__(lambda x1: x1.__serialize__()) for x0 in entity_ids],
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.tryAndRecover.undeleteCalendarItemsByIdsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_item_async(self, calendar_item: GroupScoped[CalendarItem]) -> GroupScoped[CalendarItem]:
		def do_decode(raw_result):
			return GroupScoped._deserialize(raw_result, lambda x1: deserialize_calendar_item(x1))
		payload = {
			"calendarItem": calendar_item.__serialize__(lambda x0: serialize_calendar_item(x0)),
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.tryAndRecover.undeleteCalendarItemAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def undelete_calendar_item_blocking(self, calendar_item: GroupScoped[CalendarItem]) -> GroupScoped[CalendarItem]:
		payload = {
			"calendarItem": calendar_item.__serialize__(lambda x0: serialize_calendar_item(x0)),
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.tryAndRecover.undeleteCalendarItemBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def undelete_calendar_items_async(self, calendar_items: list[GroupScoped[CalendarItem]]) -> list[GroupScoped[CalendarItem]]:
		def do_decode(raw_result):
			return [GroupScoped._deserialize(x1, lambda x2: deserialize_calendar_item(x2)) for x1 in raw_result]
		payload = {
			"calendarItems": [x0.__serialize__(lambda x1: serialize_calendar_item(x1)) for x0 in calendar_items],
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.tryAndRecover.undeleteCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def undelete_calendar_items_blocking(self, calendar_items: list[GroupScoped[CalendarItem]]) -> list[GroupScoped[CalendarItem]]:
		payload = {
			"calendarItems": [x0.__serialize__(lambda x1: serialize_calendar_item(x1)) for x0 in calendar_items],
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.tryAndRecover.undeleteCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def modify_calendar_items_async(self, entities: list[GroupScoped[CalendarItem]]) -> list[GroupScoped[CalendarItem]]:
		def do_decode(raw_result):
			return [GroupScoped._deserialize(x1, lambda x2: deserialize_calendar_item(x2)) for x1 in raw_result]
		payload = {
			"entities": [x0.__serialize__(lambda x1: serialize_calendar_item(x1)) for x0 in entities],
		...
		return await execute_async_method_job(
			...
			True,
			do_decode,
			symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.tryAndRecover.modifyCalendarItemsAsync,
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)

	def modify_calendar_items_blocking(self, entities: list[GroupScoped[CalendarItem]]) -> list[GroupScoped[CalendarItem]]:
		payload = {
			"entities": [x0.__serialize__(lambda x1: serialize_calendar_item(x1)) for x0 in entities],
		}
		call_result = symbols.kotlin.root.com.icure.cardinal.sdk.py.api.CalendarItemApi.inGroup.tryAndRecover.modifyCalendarItemsBlocking(
			self.cardinal_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))

...
private class WithEncryptionMetadataAndDelegatesParams(
	public val base: DecryptedCalendarItem?,
	public val patient: Patient?,
	public val delegates: Map<String, CalendarItemDelegateOptions>,
	public val user: User? = null,
	public val secretId: SecretIdUseOption =
			com.icure.cardinal.sdk.crypto.entities.SecretIdUseOption.UseAnySharedWithParent,
	public val alternateRootDelegateId: String? = null,
...
public fun withEncryptionMetadataAndDelegatesBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.calendarItem.withEncryptionMetadataAndDelegates(
			decodedParams.base,
			decodedParams.patient,
			decodedParams.delegates,
			decodedParams.user,
...
private class DecryptParams(
	public val calendarItems: List<EncryptedCalendarItem>,
)
...
public fun encryptOrValidateBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.calendarItem.encryptOrValidate(
			decodedParams.calendarItems,
		)
	}
...
@OptIn(InternalIcureApi::class)
public fun getCalendarItemsOccupancyByPeriodForSelfBlocking(sdk: CardinalApis, params: String):
		String = kotlin.runCatching {
	val decodedParams =
			fullLanguageInteropJson.decodeFromString<GetCalendarItemsOccupancyByPeriodForSelfParams>(params)
	runBlocking {
		sdk.calendarItem.getCalendarItemsOccupancyByPeriodForSelf(
...
@OptIn(InternalIcureApi::class)
public fun getCalendarItemsOccupancyByPeriodForHealthcarePartyBlocking(sdk: CardinalApis,
	...
	runBlocking {
		sdk.calendarItem.getCalendarItemsOccupancyByPeriodForHealthcareParty(
			decodedParams.startDate,
			decodedParams.endDate,
...
@OptIn(InternalIcureApi::class)
public fun getCalendarItemsOccupancyByPeriodAndAgendaIdBlocking(sdk: CardinalApis, params: String):
		String = kotlin.runCatching {
	val decodedParams =
			fullLanguageInteropJson.decodeFromString<GetCalendarItemsOccupancyByPeriodAndAgendaIdParams>(params)
	runBlocking {
		sdk.calendarItem.getCalendarItemsOccupancyByPeriodAndAgendaId(
			decodedParams.startDate,
			decodedParams.endDate,
...
@OptIn(InternalIcureApi::class)
public fun purgeCalendarItemsByIdsBlocking(sdk: CardinalApis, params: String): String =
		kotlin.runCatching {
	val decodedParams = fullLanguageInteropJson.decodeFromString<PurgeCalendarItemsByIdsParams>(params)
	runBlocking {
		sdk.calendarItem.purgeCalendarItemsByIds(
			decodedParams.entityIds,
		)
	}
}.toPyString(ListSerializer(StoredDocumentIdentifier.serializer()))
...
@OptIn(InternalIcureApi::class)
public fun purgeCalendarItemsBlocking(sdk: CardinalApis, params: String): String =
		kotlin.runCatching {
	val decodedParams = fullLanguageInteropJson.decodeFromString<PurgeCalendarItemsParams>(params)
	runBlocking {
		sdk.calendarItem.purgeCalendarItems(
			decodedParams.calendarItems,
		)
	}
}.toPyString(ListSerializer(StoredDocumentIdentifier.serializer()))
...
private class CreateCalendarItemsParams(
	public val entities: List<DecryptedCalendarItem>,
)

@OptIn(InternalIcureApi::class)
public fun createCalendarItemsBlocking(sdk: CardinalApis, params: String): String =
		kotlin.runCatching {
	val decodedParams = fullLanguageInteropJson.decodeFromString<CreateCalendarItemsParams>(params)
	runBlocking {
		sdk.calendarItem.createCalendarItems(
...
public fun bookCalendarItemCheckingAvailabilityBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.calendarItem.bookCalendarItemCheckingAvailability(
			decodedParams.entity,
		)
	}
}.toPyString(DecryptedCalendarItem.serializer())
...
@OptIn(InternalIcureApi::class)
public fun undeleteCalendarItemsByIdsBlocking(sdk: CardinalApis, params: String): String =
		kotlin.runCatching {
	val decodedParams =
			fullLanguageInteropJson.decodeFromString<UndeleteCalendarItemsByIdsParams>(params)
	runBlocking {
		sdk.calendarItem.undeleteCalendarItemsByIds(
			decodedParams.entityIds,
		)
	}
}.toPyString(ListSerializer(DecryptedCalendarItem.serializer()))
...
@OptIn(InternalIcureApi::class)
public fun undeleteCalendarItemsBlocking(sdk: CardinalApis, params: String): String =
		kotlin.runCatching {
	val decodedParams = fullLanguageInteropJson.decodeFromString<UndeleteCalendarItemsParams>(params)
	runBlocking {
		sdk.calendarItem.undeleteCalendarItems(
			decodedParams.calendarItems,
		)
	}
}.toPyString(ListSerializer(DecryptedCalendarItem.serializer()))
...
@OptIn(InternalIcureApi::class)
public fun modifyCalendarItemsBlocking(sdk: CardinalApis, params: String): String =
		kotlin.runCatching {
	val decodedParams = fullLanguageInteropJson.decodeFromString<ModifyCalendarItemsParams>(params)
	runBlocking {
		sdk.calendarItem.modifyCalendarItems(
			decodedParams.entities,
		)
	}
}.toPyString(ListSerializer(DecryptedCalendarItem.serializer()))

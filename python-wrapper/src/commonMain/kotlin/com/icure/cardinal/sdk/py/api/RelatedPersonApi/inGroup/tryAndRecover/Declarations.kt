// auto-generated file
package com.icure.cardinal.sdk.py.api.RelatedPersonApi.inGroup.tryAndRecover
...
public fun shareWithBlocking(sdk: CardinalApis, params: String): String = kotlin.runCatching {
	...
	runBlocking {
		sdk.relatedPerson.inGroup.tryAndRecover.shareWith(
			decodedParams.delegate,
			decodedParams.relatedPerson,
			decodedParams.options,
		)
	}
}.toPyString(GroupScoped.serializer(PolymorphicSerializer(RelatedPerson::class)))
...
public fun shareWithAsync(
	...
	GlobalScope.launch {
		...
		}.toPyStringAsyncCallback(GroupScoped.serializer(PolymorphicSerializer(RelatedPerson::class)),
				resultCallback)
	}
...
public fun shareWithManyBlocking(sdk: CardinalApis, params: String): String = kotlin.runCatching {
	...
	runBlocking {
		sdk.relatedPerson.inGroup.tryAndRecover.shareWithMany(
			decodedParams.relatedPerson,
...
public fun filterRelatedPersonsByBlocking(sdk: CardinalApis, params: String): PyResult =
	...
	runBlocking {
		sdk.relatedPerson.inGroup.tryAndRecover.filterRelatedPersonsBy(
	...
	PaginatedListIteratorWithSerializer(it,
			GroupScoped.serializer(PolymorphicSerializer(RelatedPerson::class)))}
...
public fun filterRelatedPersonsBySortedBlocking(sdk: CardinalApis, params: String): PyResult =
	...
	runBlocking {
		sdk.relatedPerson.inGroup.tryAndRecover.filterRelatedPersonsBySorted(
			decodedParams.groupId,
			decodedParams.filter,
		)
	}
...
public fun createRelatedPersonBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.relatedPerson.inGroup.tryAndRecover.createRelatedPerson(
...
private class CreateRelatedPersonsParams(
	public val entities: List<GroupScoped<RelatedPerson>>,
)
...
public fun createRelatedPersonsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.relatedPerson.inGroup.tryAndRecover.createRelatedPersons(
...
public fun undeleteRelatedPersonByIdBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.relatedPerson.inGroup.tryAndRecover.undeleteRelatedPersonById(
...
public fun undeleteRelatedPersonsByIdsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.relatedPerson.inGroup.tryAndRecover.undeleteRelatedPersonsByIds(
...
public fun undeleteRelatedPersonBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.relatedPerson.inGroup.tryAndRecover.undeleteRelatedPerson(
			decodedParams.relatedPerson,
		)
	}
}.toPyString(GroupScoped.serializer(PolymorphicSerializer(RelatedPerson::class)))
...
public fun undeleteRelatedPersonsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.relatedPerson.inGroup.tryAndRecover.undeleteRelatedPersons(
...
public fun modifyRelatedPersonBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.relatedPerson.inGroup.tryAndRecover.modifyRelatedPerson(
			decodedParams.entity,
		)
	}
}.toPyString(GroupScoped.serializer(PolymorphicSerializer(RelatedPerson::class)))
...
public fun modifyRelatedPersonsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.relatedPerson.inGroup.tryAndRecover.modifyRelatedPersons(
			decodedParams.entities,
		)
	}
}.toPyString(ListSerializer(GroupScoped.serializer(PolymorphicSerializer(RelatedPerson::class))))
...
public fun getRelatedPersonBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.relatedPerson.inGroup.tryAndRecover.getRelatedPerson(
			decodedParams.groupId,
			decodedParams.entityId,
		)
	}
...
public fun getRelatedPersonsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.relatedPerson.inGroup.tryAndRecover.getRelatedPersons(
			decodedParams.groupId,
			decodedParams.entityIds,
		)
	}

// auto-generated file
package com.icure.cardinal.sdk.py.api.AccessLogApi.inGroup.encrypted
...
private class ShareWithParams(
	...
	public val accessLog: GroupScoped<EncryptedAccessLog>,
...
public fun shareWithBlocking(sdk: CardinalApis, params: String): String = kotlin.runCatching {
	...
	runBlocking {
		sdk.accessLog.inGroup.encrypted.shareWith(
...
public fun shareWithManyBlocking(sdk: CardinalApis, params: String): String = kotlin.runCatching {
	...
	runBlocking {
		sdk.accessLog.inGroup.encrypted.shareWithMany(
			decodedParams.accessLog,
...
public fun filterAccessLogsByBlocking(sdk: CardinalApis, params: String): PyResult =
	...
	runBlocking {
		sdk.accessLog.inGroup.encrypted.filterAccessLogsBy(
...
public fun filterAccessLogsBySortedBlocking(sdk: CardinalApis, params: String): PyResult =
	...
	runBlocking {
		sdk.accessLog.inGroup.encrypted.filterAccessLogsBySorted(
			decodedParams.groupId,
			decodedParams.filter,
		)
	}
...
public fun createAccessLogBlocking(sdk: CardinalApis, params: String): String = kotlin.runCatching {
	...
	runBlocking {
		sdk.accessLog.inGroup.encrypted.createAccessLog(
...
public fun createAccessLogsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.accessLog.inGroup.encrypted.createAccessLogs(
...
public fun undeleteAccessLogByIdBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.accessLog.inGroup.encrypted.undeleteAccessLogById(
...
public fun undeleteAccessLogsByIdsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.accessLog.inGroup.encrypted.undeleteAccessLogsByIds(
...
public fun undeleteAccessLogBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.accessLog.inGroup.encrypted.undeleteAccessLog(
			decodedParams.accessLog,
		)
	}
}.toPyString(GroupScoped.serializer(EncryptedAccessLog.serializer()))
...
public fun undeleteAccessLogsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.accessLog.inGroup.encrypted.undeleteAccessLogs(
...
public fun modifyAccessLogBlocking(sdk: CardinalApis, params: String): String = kotlin.runCatching {
	...
	runBlocking {
		sdk.accessLog.inGroup.encrypted.modifyAccessLog(
			decodedParams.entity,
		)
	}
}.toPyString(GroupScoped.serializer(EncryptedAccessLog.serializer()))
...
public fun modifyAccessLogsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.accessLog.inGroup.encrypted.modifyAccessLogs(
			decodedParams.entities,
		)
	}
}.toPyString(ListSerializer(GroupScoped.serializer(EncryptedAccessLog.serializer())))
...
public fun getAccessLogBlocking(sdk: CardinalApis, params: String): String = kotlin.runCatching {
	...
	runBlocking {
		sdk.accessLog.inGroup.encrypted.getAccessLog(
			decodedParams.groupId,
			decodedParams.entityId,
		)
	}
...
public fun getAccessLogsBlocking(sdk: CardinalApis, params: String): String = kotlin.runCatching {
	...
	runBlocking {
		sdk.accessLog.inGroup.encrypted.getAccessLogs(
			decodedParams.groupId,
			decodedParams.entityIds,
		)
	}

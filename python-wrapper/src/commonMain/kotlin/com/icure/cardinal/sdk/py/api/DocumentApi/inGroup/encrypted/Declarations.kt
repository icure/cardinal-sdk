// auto-generated file
package com.icure.cardinal.sdk.py.api.DocumentApi.inGroup.encrypted
...
private class ShareWithParams(
	...
	public val document: GroupScoped<EncryptedDocument>,
...
public fun shareWithBlocking(sdk: CardinalApis, params: String): String = kotlin.runCatching {
	...
	runBlocking {
		sdk.document.inGroup.encrypted.shareWith(
...
public fun shareWithManyBlocking(sdk: CardinalApis, params: String): String = kotlin.runCatching {
	...
	runBlocking {
		sdk.document.inGroup.encrypted.shareWithMany(
			decodedParams.document,
...
public fun filterDocumentsByBlocking(sdk: CardinalApis, params: String): PyResult =
	...
	runBlocking {
		sdk.document.inGroup.encrypted.filterDocumentsBy(
...
public fun filterDocumentsBySortedBlocking(sdk: CardinalApis, params: String): PyResult =
	...
	runBlocking {
		sdk.document.inGroup.encrypted.filterDocumentsBySorted(
			decodedParams.groupId,
			decodedParams.filter,
		)
	}
...
public fun createDocumentBlocking(sdk: CardinalApis, params: String): String = kotlin.runCatching {
	...
	runBlocking {
		sdk.document.inGroup.encrypted.createDocument(
...
public fun createDocumentsBlocking(sdk: CardinalApis, params: String): String = kotlin.runCatching {
	...
	runBlocking {
		sdk.document.inGroup.encrypted.createDocuments(
...
public fun undeleteDocumentByIdBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.document.inGroup.encrypted.undeleteDocumentById(
...
public fun undeleteDocumentsByIdsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.document.inGroup.encrypted.undeleteDocumentsByIds(
...
public fun undeleteDocumentBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.document.inGroup.encrypted.undeleteDocument(
			decodedParams.document,
		)
	}
}.toPyString(GroupScoped.serializer(EncryptedDocument.serializer()))
...
public fun undeleteDocumentsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.document.inGroup.encrypted.undeleteDocuments(
...
public fun modifyDocumentBlocking(sdk: CardinalApis, params: String): String = kotlin.runCatching {
	...
	runBlocking {
		sdk.document.inGroup.encrypted.modifyDocument(
			decodedParams.entity,
		)
	}
}.toPyString(GroupScoped.serializer(EncryptedDocument.serializer()))
...
public fun modifyDocumentsBlocking(sdk: CardinalApis, params: String): String = kotlin.runCatching {
	...
	runBlocking {
		sdk.document.inGroup.encrypted.modifyDocuments(
			decodedParams.entities,
		)
	}
}.toPyString(ListSerializer(GroupScoped.serializer(EncryptedDocument.serializer())))
...
public fun getDocumentBlocking(sdk: CardinalApis, params: String): String = kotlin.runCatching {
	...
	runBlocking {
		sdk.document.inGroup.encrypted.getDocument(
			decodedParams.groupId,
			decodedParams.entityId,
		)
	}
...
public fun getDocumentsBlocking(sdk: CardinalApis, params: String): String = kotlin.runCatching {
	...
	runBlocking {
		sdk.document.inGroup.encrypted.getDocuments(
			decodedParams.groupId,
			decodedParams.entityIds,
		)
	}

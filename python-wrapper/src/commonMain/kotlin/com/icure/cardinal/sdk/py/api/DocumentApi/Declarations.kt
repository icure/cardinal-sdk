...
public fun withEncryptionMetadataAndDelegatesLinkedToMessageBlocking(sdk: CardinalApis,
	...
	runBlocking {
		sdk.document.withEncryptionMetadataAndDelegatesLinkedToMessage(
			decodedParams.base,
			decodedParams.message,
			decodedParams.delegates,
			decodedParams.user,
...
public fun withEncryptionMetadataLinkedToPatientBlocking(sdk: CardinalApis, params: String): String
	...
	runBlocking {
		sdk.document.withEncryptionMetadataLinkedToPatient(
			decodedParams.base,
...
public fun withEncryptionMetadataAndDelegatesLinkedToPatientBlocking(sdk: CardinalApis,
	...
	runBlocking {
		sdk.document.withEncryptionMetadataAndDelegatesLinkedToPatient(
			decodedParams.base,
			decodedParams.patient,
			decodedParams.delegates,
			decodedParams.user,
...
public fun withEncryptionMetadataAndDelegatesUnlinkedBlocking(sdk: CardinalApis, params: String):
	...
	runBlocking {
		sdk.document.withEncryptionMetadataAndDelegatesUnlinked(
			decodedParams.base,
			decodedParams.delegates,
			decodedParams.user,
			decodedParams.alternateRootDelegateId,
...
public fun purgeDocumentsByIdsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.document.purgeDocumentsByIds(
			decodedParams.entityIds,
		)
	}
}.toPyString(ListSerializer(StoredDocumentIdentifier.serializer()))
...
public fun undeleteDocumentsByIdsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.document.undeleteDocumentsByIds(
			decodedParams.entityIds,
		)
	}
}.toPyString(ListSerializer(DecryptedDocument.serializer()))
...
private class UndeleteDocumentsParams(
	public val documents: List<DecryptedDocument>,
)
...
public fun undeleteDocumentsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.document.undeleteDocuments(
			decodedParams.documents,
		)
	}
}.toPyString(ListSerializer(DecryptedDocument.serializer()))

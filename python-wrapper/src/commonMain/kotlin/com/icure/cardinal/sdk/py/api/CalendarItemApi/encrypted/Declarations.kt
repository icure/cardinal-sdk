...
public fun createCalendarItemBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.calendarItem.encrypted.createCalendarItem(
...
private class CreateCalendarItemsParams(
	public val entities: List<EncryptedCalendarItem>,
)
...
public fun createCalendarItemsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.calendarItem.encrypted.createCalendarItems(
...
public fun bookCalendarItemCheckingAvailabilityBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.calendarItem.encrypted.bookCalendarItemCheckingAvailability(
			decodedParams.entity,
		)
	}
}.toPyString(EncryptedCalendarItem.serializer())
...
public fun undeleteCalendarItemByIdBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.calendarItem.encrypted.undeleteCalendarItemById(
			decodedParams.id,
			decodedParams.rev,
		)
	}
...
public fun undeleteCalendarItemsByIdsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.calendarItem.encrypted.undeleteCalendarItemsByIds(
...
public fun undeleteCalendarItemBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.calendarItem.encrypted.undeleteCalendarItem(
			decodedParams.calendarItem,
		)
	}
}.toPyString(EncryptedCalendarItem.serializer())
...
public fun undeleteCalendarItemsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.calendarItem.encrypted.undeleteCalendarItems(
...
public fun modifyCalendarItemsBlocking(sdk: CardinalApis, params: String): String =
	...
	runBlocking {
		sdk.calendarItem.encrypted.modifyCalendarItems(
			decodedParams.entities,
		)
	}
}.toPyString(ListSerializer(EncryptedCalendarItem.serializer()))

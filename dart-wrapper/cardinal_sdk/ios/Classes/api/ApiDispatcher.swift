...
func dispatchApi(
  ...
  case "AnonymousAgendaApi": return AnonymousAgendaApiDispatcher.dispatch(methodName: methodName, parameters: parameters, resultCallback: resultCallback)
  ...
  case "AuthApi": return AuthApiDispatcher.dispatch(methodName: methodName, parameters: parameters, resultCallback: resultCallback)
  ...
  case "AnonymousHealthcarePartyApi": return AnonymousHealthcarePartyApiDispatcher.dispatch(methodName: methodName, parameters: parameters, resultCallback: resultCallback)
  ...
  case "CalendarItemTypeApi": return CalendarItemTypeApiDispatcher.dispatch(methodName: methodName, parameters: parameters, resultCallback: resultCallback)
